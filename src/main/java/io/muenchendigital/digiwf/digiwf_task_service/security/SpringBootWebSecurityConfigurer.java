package io.muenchendigital.digiwf.digiwf_task_service.security;
...
@EnableWebSecurity
public class SpringBootWebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    public SpringBootWebSecurityConfigurer(
